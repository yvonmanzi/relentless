...
class CategoryFactory(DjangoModelFactory):
    ...
    This factory uses Faker to generate random data for the Category model.
    It creates instances with a random word as the name and a slug derived from that name.

    Attributes:
        name (str): A random word generated by Faker.
        slug (str): A URL-friendly version of the name, automatically generated from the name.
