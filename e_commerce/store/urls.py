...
urlpatterns = [
    ...
    path('carts/<int:pk>/', CartViewSet.as_view({'put': 'update', 'delete': 'destroy'}), name='cart-update-delete')
    #TODO: Add product to cart, delete from it, checkout cart[aka place an order], etc. 
    # path('carts/<int:pk>/add_product', CartViewSet.as_view({'post': 'add_product'}), name='cart-add-product'),
